        ...
        <Fragment>
            ...
            <div className="full-width flex flex-column scroll-bar no-select">
                ...
                <main className="flex flex-space">
                    ...
                    <ul className="scroll-up flex" onClick={_ => $(".container").scrollTop(0)}>
                    ...
                    <ul className="full-width flex flex-column">
                        ...
                        <li className="full-width flex flex-space">
                            ...
                            <div className="flex flex-start">
                                ...
                                <a href={`https://web.whatsapp.com/send/?phone=${settings.whatsapp}`} className="flex" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                                ...
                                <a href={`https://t.me/${settings.telegram}`} className="flex" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                        ...
                        <li className="full-width flex flex-space align-start">
                            ...
                            <div className="flex flex-column align-start">
                                ...
                                <div><a className="head">إشترك فى موقعنا</a></div>

                                <form className="text full-width flex flex-column" onSubmit={subscribe}>

                                    <input type="email" placeholder="أدخل الإيميل" dir="rtl" className="full-width" required autoComplete="off"
                            ...
                            <div className="flex flex-column align-start">
                                ...
                                <ul className="full-width flex flex-column">
                                    ...
                                    <div><Link href="/categories">الأقسام</Link></div>
                                    <div><Link href="/">من نحن</Link></div>
                                    <div><Link href="/">تواصل معنا</Link></div>
                                </ul>
